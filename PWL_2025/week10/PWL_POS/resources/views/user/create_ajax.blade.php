            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <img id="foto-preview" src="" alt="Preview Foto"
                        style="display:none; width: 200px; height: 200px; border-radius: 50%; object-fit: cover; border: 1px solid #ddd; padding: 5px;">
                </div>
            </div>
...
<script>
    $(document).ready(function () {
        // Menampilkan preview gambar ketika file dipilih
        $("#foto").change(function (event) {
            var reader = new FileReader();
            reader.onload = function (e) {
                $("#foto-preview").attr("src", e.target.result).show(); // Menampilkan gambar
            };
        ...
        $("#form-tambah").validate({
            rules: {
                ...
                foto: { extension: "jpg|jpeg|png|gif|bmp|webp" }
            },
